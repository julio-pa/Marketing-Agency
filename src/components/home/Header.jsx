    ...
    <main>
      <div className="relative px-6 lg:px-8">
        <div className=" max-w-3xl xl:pt-40 xl:pb-64 lg:pb-48 sm:pt-48 sm:pb-40">
          <div>
            <div>
              <h1 className="text-4xl font-semibold tracking-tight pb-48  sm:text-7xl">
              ...
              <ul className='flex gap-8'>
                <li className='inline-flex transition duration-300 ease-in-out border-b-2 border-transparent hover:border-red-500'>
